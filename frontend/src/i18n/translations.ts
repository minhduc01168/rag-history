...
export const translations: Record<Language, TranslationKeys> = {
  vi: {
    ...
    common: {
      ...
      footerText: 'Đại Việt Kids AI - Trợ lý Lịch sử Tiểu học (Lớp 4 & 5)',
    },
    home: {
      title: 'Sân chơi Lịch sử Tiểu học',
      subtitle: 'Khám phá lịch sử dựng nước, giữ nước hào hùng của dân tộc Việt Nam cùng Cụ Rùa Thông Thái',
    ...
    survival: {
      ...
      fire: 'Kháng chiến chống Pháp & Mỹ (1945 - 1975)',
      water: 'Các trận thủy chiến oanh liệt',
      firstAid: 'Ôn tập tổng hợp Lịch sử Lớp 4 & 5',
      step: 'Mục',
    ...
    research: {
      title: 'Bản đồ Lịch sử Dân tộc',
      subtitle: 'Trực quan hóa các chiến công lịch sử và địa danh oanh liệt của Việt Nam',
      ...
      layerLsm: '🏛️ Di tích Lịch sử',
      layerDisaster: '⚔️ Trận đánh nổi tiếng',
      layerElevation: '🏰 Kinh đô xưa',
    ...
    bot: {
      ...
      subtitle: 'Trợ lý AI Lịch sử SGK Lớp 4 & 5 • Luôn sẵn sàng đồng hành',
      placeholder: 'Hỏi Cụ Rùa về Lịch sử Lớp 4 & 5...',
      send: 'Gửi',
      welcome: 'Xin chào cháu! Cụ Rùa Thông Thái đây 🐢. Cụ có thể giúp gì cho cháu về các bài học và câu chuyện Lịch sử Tiểu học (Lớp 4 & 5) hôm nay?',
      ...
      replyFlood: '🐘 Khởi nghĩa Hai Bà Trưng',
      replyWater: '⭐️ Chiến thắng Điện Biên Phủ 1954',
      quickWeather: 'Vua Hùng dựng nước',
      quickCpr: 'Chiến thắng Bạch Đằng',
      quickFlood: 'Hai Bà Trưng',
      quickWater: 'Điện Biên Phủ 1954',
      openBot: 'Hỏi Cụ Rùa',
    ...
    admin: {
      ...
      subtitle: 'Bảng điều khiển Quản trị Dữ liệu SGK',
      navUpload: 'Tải lên Tài liệu',
      navDocs: 'Quản lý Tài liệu',
      navManage: 'Quản lý Tài liệu',
      kbTitle: 'Quản lý Tài liệu SGK',
      kbSubtitle: 'Tải lên tài liệu SGK Lịch sử mới để nạp vào hệ thống RAG',
  ...
  en: {
    ...
    common: {
      ...
      footerText: 'Dai Viet Kids AI - Elementary History Assistant (Grades 4 & 5)',
    },
    home: {
      title: 'Elementary History Playground',
      subtitle: 'Explore heroic Vietnamese history with Wise Turtle AI Assistant',
    ...
    survival: {
      ...
      fire: 'Resistance Wars (1945 - 1975)',
      water: 'Great Naval Battles',
    ...
    research: {
      ...
      subtitle: 'Visualizing historical battles and historic landmarks of Vietnam',
      ...
      layerLsm: '🏛️ Historic Landmarks',
      layerDisaster: '⚔️ Famous Battles',
      layerElevation: '🏰 Ancient Capitals',
    ...
    bot: {
      ...
      subtitle: 'History AI Assistant (Grades 4 & 5) • Ready to help',
      placeholder: 'Ask Wise Turtle about History 4 & 5...',
      send: 'Send',
      welcome: 'Hello! I am Wise Turtle 🐢. How can I help you with your Grades 4 & 5 History lessons and stories today?',
      ...
      replyFlood: '🐘 Trung Sisters Uprising',
      replyWater: '⭐️ Dien Bien Phu Victory 1954',
      quickWeather: 'Hung Kings Era',
      quickCpr: 'Bach Dang Battle',
      quickFlood: 'Trung Sisters',
      quickWater: 'Dien Bien Phu 1954',
